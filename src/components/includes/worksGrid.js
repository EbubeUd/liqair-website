...
function worksGrid(props) {
  ...
  <div className={"col-md-4 works-grid-img-holder " + worksImgGridStyle} >
    ...
    <div className={"col-md-4 works-grid-img-holder " + worksImgGridStyle} >
    <a href="/client/umc">
      <img alt="img" src="/assets/img/pictures/use my car1.jpg" className="img-responsive grid-image" />
      <div className={"works-grid-img-overlay h-100"} style={imageOverlayDisplay}>
      <div className="grid-middle-text clickable">
          <img alt="img" className="grid-middle-item"
            src="/assets/img/spinners/liqair-loader-small.gif"
            style={{ margin: "auto", maxWidth: "7%" }}
          />
    ...
    <a href="/client/umc">
      ...
      <img alt="img" src="/assets/img/pictures/use my car2.jpg" className="img-responsive grid-image" />
      <div className={"works-grid-img-overlay h-100"} style={imageOverlayDisplay}>
      <div className="grid-middle-text clickable">
          <img alt="img" className="grid-middle-item"
            src="/assets/img/spinners/liqair-loader-small.gif"
  ...
  <div className={"col-md-4 works-grid-img-holder " + worksImgGridStyle} >
      ...
      <img  alt="img" src="/assets/img/pictures/bad hair day.jpg" className="img-responsive grid-image" />
      <div className={"works-grid-img-overlay h-100" } style={imageOverlayDisplay}>
        <div className="grid-middle-text clickable">
          <img alt="img" className="grid-middle-item"
            src="/assets/img/spinners/liqair-loader-small.gif"
  ...
  <div className={"col-md-4 works-grid-img-holder " + worksImgGridStyle} >
    <a href="/client/life">
      <img alt="img" src="/assets/img/pictures/life.jpg" className="img-responsive grid-image" />
      <div className={"works-grid-img-overlay h-100"} style={imageOverlayDisplay}>
      <div className="grid-middle-text clickable">
          <img alt="img" className="grid-middle-item"
            src="/assets/img/spinners/liqair-loader-small.gif"
  ...
  <div className={"col-md-4 works-grid-img-holder " + worksImgGridStyle} >
  <a href="/client/oma">
      <img alt="img" src="/assets/img/clients/oma/oma.jpg" className="img-responsive grid-image" />
      <div className={"works-grid-img-overlay h-100" } style={imageOverlayDisplay}>
      <div className="grid-middle-text clickable">
          <img alt="img" className="grid-middle-item"
            src="/assets/img/spinners/liqair-loader-small.gif"
...
<div className={"col-md-6 works-grid-img-holder " + worksImgGridStyle} >
  ...
  <div className={"col-md-6 works-grid-img-holder " + worksImgGridStyle} >
    <img alt="img" src={"/assets/img/clients" + props.imageUrls[1]} className="img-responsive grid-image" />
    <div className={"works-grid-img-overlay h-100"} style={imageOverlayDisplay}>
    <div className="grid-middle-text clickable">
        <img alt="img" className="grid-middle-item"
          src="/assets/img/spinners/liqair-loader-small.gif"
...
<div className={"col-md-6 works-grid-img-holder " + worksImgGridStyle} >
    <img alt="img" src={"/assets/img/clients" + props.imageUrls[2]} className="img-responsive grid-image" />
    <div className={"works-grid-img-overlay h-100" } style={imageOverlayDisplay}>
    <div className="grid-middle-text clickable">
        <img alt="img" className="grid-middle-item"
          src="/assets/img/spinners/liqair-loader-small.gif"
  ...
  <div className={"col-md-6 works-grid-img-holder " + worksImgGridStyle} >
    <img alt="img" src={"/assets/img/clients" + props.imageUrls[3]} className="img-responsive grid-image" />
    <div className={"works-grid-img-overlay h-100"} style={imageOverlayDisplay}>
    <div className="grid-middle-text clickable">
        <img alt="img" className="grid-middle-item"
          src="/assets/img/spinners/liqair-loader-small.gif"
