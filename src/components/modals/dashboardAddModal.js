...
export class DashboardAddModal extends Component {
    ...
    render() {
        return (
            <div className="text-dark">
                <button id={this.props.id+'ModalOpen'} type="button" className="d-none" data-toggle="modal" data-target={'#'+this.props.id+'AddModal'}>Open</button>

                <div id={this.props.id+'AddModal'} className="modal fade" tabIndex={-1} role="dialog" aria-labelledby="addModalLabel" aria-hidden="true">
